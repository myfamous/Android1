...
{
    public class MyReactButton : TextView, PopupWindow.IOnDismissListener
    {
        //ReactButton custom view object to make easy to change attribute
        private MyReactButton MReactButton;
        ...
        protected MyReactButton(IntPtr javaReference, JniHandleOwnership transfer) : base(javaReference, transfer)
        {
        }

        public MyReactButton(Context context) : base(context)
        {
            MainContext = context;
            Init();
        ...
        public MyReactButton(Context context, IAttributeSet attrs) : base(context, attrs)
        {
            MainContext = context;
            Init();
            ReactButtonDefaultSetting();
        ...
        public MyReactButton(Context context, IAttributeSet attrs, int defStyleAttr) : base(context, attrs, defStyleAttr)
        {
            MainContext = context;
            Init();
            ReactButtonDefaultSetting();
        ...
        public MyReactButton(Context context, IAttributeSet attrs, int defStyleAttr, int defStyleRes) : base(context, attrs, defStyleAttr, defStyleRes)
        {
            MainContext = context;
            Init();
            ReactButtonDefaultSetting();
                                ...
                                default:
                                    {
                                        ...
                                        var likeCount = PostData.View?.FindViewById<MyReactButton>(Resource.Id.ReactButton);
        ...
        private void ReactButtonDefaultSetting()
        {
            try
            {
                ...
                {
                    case true:
                        MReactButton.SetCompoundDrawablesWithIntrinsicBounds(null, icon, null, null);
                        break;
                    default:
                        MReactButton.SetCompoundDrawablesWithIntrinsicBounds(null, icon, null, null);
                        break;
        ...
        private void UpdateReactButtonByReaction(Reaction react)
        {
            try
            {
                ...
                //if ("#888888" == react.GetReactTextColor())
                //    MReactButton.SetTextColor(Color.ParseColor("#f1f1f1"));
                //else
                //    MReactButton.SetTextColor(Color.ParseColor(react.GetReactTextColor()));
                MReactButton.SetTextColor(Color.ParseColor("#ffffff"));
