            ...
            try
            {
                ...
                if (MessageModel != null)
                {
                    if (AppSettings.ShowNotificationWithUpload)
                        AppNotificationsManager.Instance.ShowUpDownNotification(context, MessageModel.UserName, MessageModel.MessageHashId, MessageModel.UserId, MessageModel.ChatId);
