            ...
            try
            {
               ...
               // Methods.App.FullScreenApp(this);
                ...
                if (UserData.IsNotifyStopped != null && UserData.IsNotifyStopped.Value == 1)
                {
                    ...
                    imnot.SetImageResource(Resource.Drawable.ic_notifications_on_vector);
                    ToastUtils.ShowToast(this, GetString(Resource.String.Lbl_NotificationsAreTurnedOn), ToastLength.Short);
                }
                else
                {
                    UserData.IsNotifyStopped = 1;
                    imnot.SetImageResource(Resource.Drawable.ic_notifications_off_vector);
                    ToastUtils.ShowToast(this, GetString(Resource.String.Lbl_NotificationsHaveBeenStopped), ToastLength.Short);
                }
...
//#pragma warning restore 618
        ...
        private void InitComponent()
        {
            try
            {
               ...
               // BtnMore = FindViewById<ImageButton>(Resource.Id.BtnMore);
                ...
                imnot = FindViewById<ImageView>(Resource.Id.imnot);
                ...
                switch (addEvent)
                {
                    ...
                    case true:
                       ...
                       // BtnMore.Click += BtnMoreOnClick;
                        ...
                        rlmore.Click += Rlmore_Click;
                        imnot.Click += Imnot_Click;
                        break;
                    default:
                        ImageCover.Click -= ImageCoverOnClick;
                        ImageBack.Click -= ImageBackOnClick;
        ...
        private void Imnot_Click(object sender, EventArgs e)
        {
            StopNotifyLayoutOnClick(UserData);
        }

        private void Rlmore_Click(object sender, EventArgs e)
        {
            try
            {
                var searchFilter = new FollowMoreBottomFragment2(this);
            ...
            else
            {
                RunOnUiThread(() =>
                {
                    ...
                    { 
                        ...
                        try { PostFeedAdapter?.ListDiffer?.Remove(check4); } catch { }
                        try { PostFeedAdapter?.ListDiffer?.Remove(check3); } catch { }
                        if (postPrivacy == "1")
                        {
                            if (check7 != null)
                            {
