...
namespace WoWonder.Activities.MyProfile
{
    ...
    public class MyProfileActivity : BaseActivity, MaterialDialog.IListCallback/*, AppBarLayout.IOnOffsetChangedListener*/ 
    {
        ...
        public RelativeLayout RlSearch, RlMessage, RlMessage2, RlReels, RlAdd, RlProfile, rl_settings, rl_edit;
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            try
            {
                ...
                SetTheme(AppSettings.SetTabDarkTheme ? Resource.Style.MyTheme_Base : Resource.Style.MyTheme_Base);
...
//            }
        ...
        private void InitComponent()
        {
            try
            {
                ...
                rl_edit = FindViewById<RelativeLayout>(Resource.Id.rl_edit);
                ...
                ivHome2 = FindViewById<ImageView>(Resource.Id.ivHome2);
                ivHome2.SetColorFilter(Color.ParseColor("#2d3437"));
            ...
            try
            {
                switch (addEvent)
                {
                    ...
                    case true:
                        ...
                        rl_edit.Click += BtnMoreOnClick;
                        RlAdd.Click += RlAdd_Click;
        ...
        private void Rl_settings_Click(object sender, EventArgs e)
        {
            ...
            TabbedMainActivity.GetInstance().gotosettings();
            this.Finish();
        }
        ...
        private void RlAdd_Click(object sender, EventArgs e)
        {
            try
            {
        ...
        private void BtnMoreOnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                var searchFilter = new MoreSettingsBottomFragment();
        ...
        private void LoadPassedDate(UserDataObject result)
        {
            try
            {
                ...
                if (checkAboutBox != null)
                    PostFeedAdapter?.ListDiffer?.Remove(checkAboutBox); 
                ...
                if(checkInfoUserBox!=null)
                    PostFeedAdapter?.ListDiffer?.Remove(checkInfoUserBox);
        ...
        public void LoadFriendsLayout(List<UserDataObject> followers, string friendsCounter)
        {
            try
            {
                if (followers?.Count > 0)
                {
                    ...
                    var check = PostFeedAdapter?.ListDiffer?.FirstOrDefault(a => a.TypeView == PostModelType.FollowersBox);
                    if(check!=null)
                        PostFeedAdapter?.ListDiffer?.Remove(check);
                    //if (check != null)
                    //{
        ...
        public void OnCopeLinkToProfile_Button_Click()
        {
            try
            {
        ...
        //Event Menu >> Share
        public async void OnShare_Button_Click()
        {
            try
            {
        ...
        public void OnViewPrivacy_Button_Click()
        {
            try
            {
        ...
        //Event Menu >> View Privacy Shortcuts
        public void OnMyActivities_Button_Click()
        {
            try
            {
        ...
        public void OnSettingsAccount_Button_Click()
        {
            try
            {
        ...
        public async Task Update_Image_Api(string type, string path)
        {
            try
            {
                if (!Methods.CheckConnectivity())
