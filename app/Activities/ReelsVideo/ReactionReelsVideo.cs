...
namespace WoWonder.Activities.ReelsVideo
{
    public class ReactionReelsVideo : Java.Lang.Object, PopupWindow.IOnDismissListener
    {
        ...
        /// </summary>
        public void ClickDialog(GlobalClickEventArgs postData,ImageView image)
        {
            try
            {
                PostData = postData;
        ...
        public void ImgButtonOnTouch(ReactionsTouchEventArgs e)
        {
            try
            {
        ...
        public void ImgButtonOnClick(ReactionsClickEventArgs e, GlobalClickEventArgs postData)
        {
            ...
            try
            {
                ...
                if (data != null)
                {
                    ...
                    ViewReelsVideoFragment.TxtLikeCount.Tag = "Liked";
                }
