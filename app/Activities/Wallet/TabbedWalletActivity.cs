...
namespace WoWonder.Activities.Wallet
{
    ...
    public class TabbedWalletActivity : BaseActivity, IPaymentResultListener, TabLayoutMediator.ITabConfigurationStrategy
    {
        ...
        public WithdrawalsFragment WithDrawalsFragment ;
        ...
        private void SetUpViewPager(ViewPager2 viewPager)
        {
            try
            {
                ...
                WithDrawalsFragment = new WithdrawalsFragment();
                ...
                Adapter.AddFragment(WithDrawalsFragment, GetText(Resource.String.Lbl_Withdrawals));
