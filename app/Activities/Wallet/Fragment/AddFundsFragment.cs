...
namespace WoWonder.Activities.Wallet.Fragment
{
    public class AddFundsFragment : AndroidX.Fragment.App.Fragment, MaterialDialog.IListCallback, MaterialDialog.ISingleButtonCallback, IPaymentResultListener
    {
        ...
        public string Price;
        public TabbedWalletActivity GlobalContext;
        ...
        private void BtnContinueOnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                var searchFilter = new addFundBottomFragment();
        ...
        public void OpenIntentCreditCard()
        {
            try
            {
        ...
        public void OpenIntentBankTransfer()
        {
            try
            {
        ...
        public async Task PayStack(string email)
        {
            try
            {
                if (Methods.CheckConnectivity())
        ...
        public EditText TxtName, TxtEmail, TxtPhone;
        ...
        public async Task CashFree(string name, string email, string phone)
        {
            try
            {
                if (Methods.CheckConnectivity())
