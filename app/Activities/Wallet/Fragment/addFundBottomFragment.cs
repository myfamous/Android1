...
{
    public class addFundBottomFragment : BottomSheetDialogFragment
    {
        ...
        private void Lv_ItemClick(object sender, AdapterView.ItemClickEventArgs e)
        {
            try
            {
                ...
                {
                    GlobalContext.AddFundsFragment.InitPayPalPayment.BtnPaypalOnClick(GlobalContext.AddFundsFragment.Price, "AddFunds");
                }
                else if (text == GetString(Resource.String.Lbl_CreditCard))
                {
                    GlobalContext.AddFundsFragment.OpenIntentCreditCard();
                }
                else if (text == GetString(Resource.String.Lbl_BankTransfer))
                {
                    GlobalContext.AddFundsFragment.OpenIntentBankTransfer();
                }
                else if (text == GetString(Resource.String.Lbl_RazorPay))
                {
                    GlobalContext.AddFundsFragment.InitRazorPay?.BtnRazorPayOnClick(GlobalContext.AddFundsFragment.Price, "AddFunds", "");
                }
                
                else if (text == GetString(Resource.String.Lbl_CashFree))
                {
                    GlobalContext.AddFundsFragment.OpenCashFreeDialog();
                }
