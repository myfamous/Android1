...
{
    public class CountriesBottomFragment : BottomSheetDialogFragment
    {
        ...
        private void InitComponent(View view)
        {
            try
            {
                ...
                title.Text = GetText(Resource.String.Lbl_Country);
                lv = view.FindViewById<BottomSheetListView>(Resource.Id.SimplelistView);
                items = WoWonderTools.GetCountryList(GlobalContext).ToList().Select(s=>s.Value).ToArray();
