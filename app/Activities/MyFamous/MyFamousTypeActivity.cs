...
namespace WoWonder.Activities.MyPhoto
{
    ...
    public class MyFamousTypeActivity : BaseActivity
    {
        ...
        LinearLayout llroyal, llgold, llsilver, llmyfamous;
        #endregion
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            try
            {
                ...
                SetContentView(Resource.Layout.Layout_Myfamouscategory);
                // llroyal, llgold, llsilver, llmyfamous, llguest;

                llroyal = FindViewById<LinearLayout>(Resource.Id.llroyal);
                llgold = FindViewById<LinearLayout>(Resource.Id.llgold);
                llsilver = FindViewById<LinearLayout>(Resource.Id.llsilver);
                llmyfamous = FindViewById<LinearLayout>(Resource.Id.llmyfamous);
                //llguest = FindViewById<LinearLayout>(Resource.Id.llguest);

                llroyal.Click += Llroyal_Click;
                llgold.Click += Llroyal_Click;
                llsilver.Click += Llroyal_Click;
                llmyfamous.Click += Llroyal_Click;
        ...
        private void Llroyal_Click(object sender, EventArgs e)
        {
            try
            {
                var intent = new Intent(this, typeof(MyFamousResaultsActivity));
        ...
        private void InitToolbar()
        {
            try
            {
                ...
                if (toolBar != null)
                {
                    toolBar.Title = GetText(Resource.String.Lbl_myFamous);
