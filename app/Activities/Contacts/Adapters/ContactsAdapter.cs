...
namespace WoWonder.Activities.Contacts.Adapters
{
    public class ContactsAdapter : RecyclerView.Adapter, ListPreloader.IPreloadModelProvider
    {
        ...
        public override RecyclerView.ViewHolder OnCreateViewHolder(ViewGroup parent, int viewType)
        {
            try
            {
                ...
                var vh = new ContactsAdapterViewHolder(itemView, FollowButtonClick, Click, LongClick,ActivityContext,UserList);
                return vh;
            }
    ...
    {
        public ContactsAdapterViewHolder(View itemView, Action<ContactsAdapterClickEventArgs> followButtonClickListener, Action<ContactsAdapterClickEventArgs> clickListener, Action<ContactsAdapterClickEventArgs> longClickListener,Activity context,ObservableCollection<UserDataObject> UserList=null) : base(itemView)
        {
            try
            {
                MainView = itemView;
                ...
                moreicon = MainView.FindViewById<ImageView>(Resource.Id.moreicon);
                ...
                if (context?.GetType() != typeof(MyContactsActivity))
                ...
                moreicon.Click += delegate
                  {
                      try
                      {
                          var searchFilter = new FollowMoreBottomFragment((MyContactsActivity)context, UserList[BindingAdapterPosition]);
                          searchFilter.Show(((AppCompatActivity)context)?.SupportFragmentManager, "CountryFilter");
                      }
                      catch
                      {
