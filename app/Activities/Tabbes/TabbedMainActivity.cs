...
using WoWonder.Activities.NativePost;
...
namespace WoWonder.Activities.Tabbes
{
    ...
    public class TabbedMainActivity : AppCompatActivity, MaterialDialog.IListCallback 
    {
        ...
        public BottomNavigationTab BottomNavigationTab;
        ...
        public RelativeLayout RlSearch, RlMessage, RlMessage2, RlReels, RlAdd, RlProfile, rl_settings;
        CircleImageView iv_round_story;
        ImageView imsettings;
        LinearLayout llHome2,llTrending2, llNotification2, llMore2;
        #endregion
        ...
        private void InitComponent()
        {
            try
            {
                ...
                RlMessage2 = FindViewById<RelativeLayout>(Resource.Id.rl_mymessage);
                ...
                RlProfile = FindViewById<RelativeLayout>(Resource.Id.rlprofileimg);
                rl_settings = FindViewById<RelativeLayout>(Resource.Id.rl_settings);
                iv_round_story = FindViewById<CircleImageView>(Resource.Id.iv_round_story);
                imsettings = FindViewById<ImageView>(Resource.Id.imsettings);
                llHome2 = FindViewById<LinearLayout>(Resource.Id.llHome2);
                llTrending2= FindViewById<LinearLayout>(Resource.Id.llTrending2);
                llNotification2 = FindViewById<LinearLayout>(Resource.Id.llNotification2);
                llMore2 = FindViewById<LinearLayout>(Resource.Id.llMore2);
                var myProfile = ListUtils.MyProfileList?.FirstOrDefault();
                GlideImageLoader.LoadImage(this, myProfile.Avatar, iv_round_story, ImageStyle.RoundedCrop, ImagePlaceholders.Drawable);
                ...
                RlFilter.Visibility = AppSettings.ShowFilterPost ? ViewStates.Visible : ViewStates.Gone;
            ...
            try
            {
                switch (addEvent)
                {
                    ...
                    case true: 
                        ...
                        RlMessage2.Click += RlMessageOnClick;
                        RlAdd.Click += BtnAddOnClick;
                        RlReels.Click += RlReelsOnClick;
                        RlProfile.Click += RlProfile_Click;
                        rl_settings.Click += Rl_settings_Click;
                        rl_settings.LongClick += Rl_settings_LongClick;
                        llHome2.Click += LlHome2_Click;
                        llTrending2.Click += LlTrending2_Click;
                        llNotification2.Click += LlNotification2_Click;
                        llMore2.Click += LlMore2_Click;
                        break;
                    default: 
                        FloatingActionButton.Click -= Btn_AddPost_OnClick;
                        RlSearch.Click -= RlSearchOnClick; 
        ...
        private void Rl_settings_LongClick(object sender, View.LongClickEventArgs e)
        {
            BottomNavigationTab.NotificationLayout.PerformClick();
        }

        private void LlMore2_Click(object sender, EventArgs e)
        {
            StartActivity(new Intent(this, typeof(PeopleNearByActivity)));
        }

        private void LlNotification2_Click(object sender, EventArgs e)
        {
            StartActivity(new Intent(this, typeof(TabbedMarketActivity)));
        }

        private void LlTrending2_Click(object sender, EventArgs e)
        {
            StartActivity(new Intent(this, typeof(MyFamousTypeActivity)));
        }

        private void LlHome2_Click(object sender, EventArgs e)
        {
            BottomNavigationTab.SelectItem(0);
            
            FindViewById<ImageView>(Resource.Id.ivHome2).SetColorFilter(Color.ParseColor("#C53B8E"));
            imsettings.SetColorFilter(Color.ParseColor("#2d3437"));
        }

        private void Rl_settings_Click(object sender, EventArgs e)
        {
            gotosettings();
        }
        public void gotosettings()
        {
            BottomNavigationTab.SelectItem(3);
            FindViewById<ImageView>(Resource.Id.ivHome2).SetColorFilter(Color.ParseColor("#2d3437"));
            imsettings.SetColorFilter(Color.ParseColor("#C53B8E"));
        }

        private void RlProfile_Click(object sender, EventArgs e)
        {
        ...
        private void BtnAddOnClick(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //StartActivity(intent);
                var searchFilter = new AddPostBottomFragmentMainActivity();
                searchFilter.Show(SupportFragmentManager, "CountryFilter");
            }
            catch (Exception exception)
            {
                Methods.DisplayReportResultTrack(exception);
        ...
        private void RlFilterOnClick(object sender, EventArgs e)
        {
            try
            {
                FilterPostDialogFragment dialogFragment = new FilterPostDialogFragment();
                        ...
                        case 0:
                            {
                                ...
                                Activity.RlFilter.Visibility = AppSettings.ShowFilterPost ? ViewStates.Visible : ViewStates.Gone;
                                break;
                            }
                        // Notifications_Tab
                        case 1:
                        ...
                        case 3:
                            {
                                ...
                                Activity.FindViewById<ImageView>(Resource.Id.ivHome).SetColorFilter(Color.ParseColor("#C53B8E"));
                                Activity.imsettings.SetColorFilter(Color.ParseColor("#2d3437"));
                                Activity.RlFilter.Visibility = ViewStates.Gone;
        ...
        private void ShowDialogAddStory()
        {
            try
            {
                ...
                //dialogList.AlwaysCallSingleChoiceCallback();
                //dialogList.ItemsCallback(this).Build().Show();
                var searchFilter = new AddPostBottomFragment();
                searchFilter.Show(this.SupportFragmentManager, "CountryFilter");
            }
            catch (Exception e)
            {
                Methods.DisplayReportResultTrack(e);
        ...
        public void GetGeneralAppData()
        {
            try
            {
                ...
                if (Methods.CheckConnectivity())
                    PollyController.RunRetryPolicyFunction(new List<Func<Task>> { () => ApiRequest.Get_MyProfileData_Api(this), ApiRequest.GetMyGroups, ApiRequest.GetMyPages, ApiRequest.GetLastArticles, ApiRequest.LoadSuggestedUser, ApiRequest.LoadSuggestedGroup, ApiRequest.LoadSuggestedPage, ApiPostAsync.GetAllPostVideo });
        ...
        public async Task CheckAndGetLocation()
        {
            try
            {
        ...
        public static int CountRateApp;
