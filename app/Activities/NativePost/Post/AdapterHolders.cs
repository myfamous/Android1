...
namespace WoWonder.Activities.NativePost.Post
{
    ...
    { 
        ...
        public class PostBottomSectionViewHolder : RecyclerView.ViewHolder, View.IOnClickListener, View.IOnLongClickListener
        {
            ...
            public TextView likenumbercountText { get; private set; }
            public PostBottomSectionViewHolder(View itemView, NativePostAdapter postAdapter, PostClickListener postClickListener) : base(itemView)
            {
                try
                {
                    ...
                    likenumbercountText = itemView.FindViewById<TextView>(Resource.Id.likenumbercountText);
        ...
        public class StoryViewHolder : RecyclerView.ViewHolder, View.IOnClickListener
        {
            ...
            public RecyclerView StoryFamousRecyclerView { get; private set; }
            public StoryAdapter StoryAdapter { get; private set; }
            public StoryFamousAdapter StoryAdapter2 { get; private set; }
            public TextView AboutHead { get; private set; }
            public TextView AboutMore { get; private set; }
            public LinearLayout layoutviewtype { get;private set; }
            public LinearLayout layoutvideoreels { get; set; }
            ...
            public StoryViewHolder(View itemView, NativePostAdapter postAdapter, PostClickListener postClickListener) : base(itemView)
            {
                try
                {
                    ...
                    StoryFamousRecyclerView = MainView.FindViewById<RecyclerView>(Resource.Id.Recylerfamous);
                    ...
                    layoutviewtype = MainView.FindViewById<LinearLayout>(Resource.Id.layoutviewtype);
                    layoutvideoreels = MainView.FindViewById<LinearLayout>(Resource.Id.llvideoreels);
                    AboutHead.Visibility = ViewStates.Visible;
                    AboutMore.Visibility = ViewStates.Gone;
                    layoutviewtype.Visibility = ViewStates.Visible;
                    if (AboutMore != null)
                    {
                        AboutMore.Visibility = ViewStates.Invisible;
                        AboutMore.SetOnClickListener(this);
                    }
                    layoutvideoreels.SetOnClickListener(this);
                    ...
                    StoryFamousRecyclerView?.SetLayoutManager(new LinearLayoutManager(PostAdapter.ActivityContext, LinearLayoutManager.Horizontal, false));

                    StoryAdapter = new StoryAdapter(PostAdapter.ActivityContext);
                    StoryAdapter2 = new StoryFamousAdapter(PostAdapter.ActivityContext);
                    StoryAdapter2.StoryList = StoryAdapter.StoryList;
                    StoryRecyclerView?.SetAdapter(StoryAdapter);
                    StoryFamousRecyclerView?.SetAdapter(StoryAdapter2);

                    StoryAdapter.ItemClick += TabbedMainActivity.GetInstance().StoryAdapterOnItemClick;
                    StoryAdapter2.ItemClick += TabbedMainActivity.GetInstance().StoryAdapterOnItemClick;
                }
                catch (Exception e)
                {
                    Methods.DisplayReportResultTrack(e); 
            ...
            public void OnClick(View v)
            {
                try
                {
                    ...
                    if(v.Id == layoutvideoreels.Id)
                    {
                        ((TabbedMainActivity)(PostAdapter.ActivityContext)).RlReels.CallOnClick();
                    }
                }
                catch (Exception e)
                {
                ...
                try
                {
                    if (BindingAdapterPosition != RecyclerView.NoPosition)
                    {
                        ...
                        if (v.Id == layoutvideoreels.Id)
                        {
                            try
                            {
                                var intent = new Intent(PostAdapter.ActivityContext, typeof(ReelsVideoDetailsActivity));
        ...
        public class MyProfileInfoHeaderSectionHolder : RecyclerView.ViewHolder, View.IOnClickListener
        {
            ...
            public TextView CountFollowers { get; private set; }
            public TextView CountFamous { get; private set; }
            public TextView CountFollowing { get; private set; }
            ...
            public MyProfileInfoHeaderSectionHolder(View itemView, NativePostAdapter postAdapter, PostClickListener postClickListener) : base(itemView)
            {
                try
                {
                    ...
                    CountFollowers = itemView.FindViewById<TextView>(Resource.Id.CountFollowers);
                    CountFamous = itemView.FindViewById<TextView>(Resource.Id.CountFamous);
                    CountFollowing = itemView.FindViewById<TextView>(Resource.Id.CountFollowing);
            ...
            public void OnClick(View v)
            {
                try
                {
                    if (BindingAdapterPosition != RecyclerView.NoPosition)
                    {
                        ...
                        else if (v.Id == LlCountFollowers.Id)
                            LlCountFollowers_Click(item?.UserData?.UserId);
                        else if (v.Id == LlCountFollowing.Id)
                            LlCountFollowing_Click(item?.UserData?.UserId);
                        //else if (v.Id == LlPoint.Id)
        ...
        public class UserProfileInfoHeaderSectionHolder : RecyclerView.ViewHolder, View.IOnClickListener
        {
            ...
            public TextViewWithImages TxtName { get; private set; }
            public TextView TxtUsername { get; private set; }
            public Button BtnFollow { get; private set; }
           // public TextView TxtFollow { get; private set; }
            ...
            public TextView txtinsta { get; private set; }
            public ImageView txttiktok { get; private set; }
            public TextView txtsnapchat { get; private set; }
            public TextView txtfb { get; private set; }
            public TextView txttwitter { get; private set; }
            public TextView txtyoutube { get; private set; }
            public SuperTextView AboutDescription;
            public UserProfileInfoHeaderSectionHolder(View itemView, NativePostAdapter postAdapter, PostClickListener postClickListener) : base(itemView)
            {
                try
                {
                    ...
                    TxtName = itemView.FindViewById<TextViewWithImages>(Resource.Id.name_profile);
                    TxtUsername = itemView.FindViewById<TextView>(Resource.Id.username_profile);
                    BtnFollow = itemView.FindViewById<Button>(Resource.Id.btnEdit);
                    ...
                    txtinsta = itemView.FindViewById<TextView>(Resource.Id.txtinsta);
                    txttiktok = itemView.FindViewById<ImageView>(Resource.Id.txttiktok);
                    txtsnapchat = itemView.FindViewById<TextView>(Resource.Id.txtsnapchat);
                    txtfb = itemView.FindViewById<TextView>(Resource.Id.txtfb);
                    txttwitter = itemView.FindViewById<TextView>(Resource.Id.txttwitter);
                    txtyoutube = itemView.FindViewById<TextView>(Resource.Id.txtyoutube);

                    FontUtils.SetTextViewIcon( FontsIconFrameWork.IonIcons, txtinsta, IonIconsFonts.LogoInstagram);
                    //FontUtils.SetTextViewIcon( FontsIconFrameWork.FontAwesomeBrands , txttiktok, FontAwesomeIcon.tiktok);
                    FontUtils.SetTextViewIcon( FontsIconFrameWork.IonIcons, txtsnapchat, IonIconsFonts.LogoSnapchat);
                    FontUtils.SetTextViewIcon(FontsIconFrameWork.IonIcons, txtfb, IonIconsFonts.LogoFacebook);
                    FontUtils.SetTextViewIcon( FontsIconFrameWork.IonIcons, txttwitter, IonIconsFonts.LogoTwitter);
                    FontUtils.SetTextViewIcon( FontsIconFrameWork.IonIcons, txtyoutube, IonIconsFonts.LogoYoutube);
                    //txttiktok
                    txtinsta.SetTextColor(Color.ParseColor("#e4405f"));
                   // txttiktok.SetTextColor(Color.ParseColor("#111111"));
                    txtsnapchat.SetTextColor(Color.ParseColor("#FFFC00"));
                    txtfb.SetTextColor(Color.ParseColor("#3b5999"));
                    txttwitter.SetTextColor(Color.ParseColor("#55acee"));
                    txtyoutube.SetTextColor(Color.ParseColor("#cd201f"));
                    ...
                    switch (UserData.IsFollowing)
                    {
                        ...
                        case "0":
                           ...
                           // TxtFollow.SetTextColor(Color.ParseColor(AppSettings.MainColor));
                            ...
                            //BtnFollow.SetCardBackgroundColor(AppSettings.SetTabDarkTheme ? Color.ParseColor("#C3C7D0") : Color.ParseColor("#C3C7D0"));
                            BtnFollow.SetBackgroundResource(Resource.Drawable.round_button_normal2);
                        ...
                        case "1":
                            ...
                            //  BtnFollow.SetCardBackgroundColor(Color.ParseColor("0095f6"));
                            BtnFollow.SetBackgroundResource(Resource.Drawable.round_button_pressed2);
                            BtnFollow.Tag = "friends";
                            break;
                        //>> Request
                        case "2":
