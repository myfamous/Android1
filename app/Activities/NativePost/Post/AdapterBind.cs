    ...
    public class AdapterBind  
    {
        ...
        public void BottomPostPartBind(AdapterHolders.PostBottomSectionViewHolder holder, AdapterModelsClass item)
        {
            ...
            {  
                ...
                holder.likenumbercountText.Text = item.PostData.PostLikes + " " + ActivityContext.GetString(Resource.String.Lbl_lovethis); 
                switch (AppSettings.PostButton)
                {
                    case PostButtonSystem.ReactionDefault:
                    case PostButtonSystem.ReactionSubShine:
        ...
        public void TextSectionPostPartBind(AdapterHolders.PostTextSectionViewHolder holder ,AdapterModelsClass item)
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        if (holder.Description.Text.Contains("http") || holder.Description.Text.Contains(ActivityContext.GetText(Resource.String.Lbl_ReadMore)) || holder.Description.Text.Contains(ActivityContext.GetText(Resource.String.Lbl_ReadLess)))
        ...
        public void MyProfileInfoHeaderSectionBind(AdapterHolders.MyProfileInfoHeaderSectionHolder holder, AdapterModelsClass item)
        {
            try
            {
                ...
                { 
                    ...
                    holder.CountFollowing.Text = following;
            ...
            try
            {
                if (item.InfoUserModel.UserData != null)
                {
                    ...
                    try
                    {
                        ...
                        holder.AboutDescription.SetAutoLinkOnClickListener(NativePostAdapter, new Dictionary<string, string>());
                        holder.AboutDescription.Text = Methods.FunString.DecodeString(item.InfoUserModel.UserData.About);
                        NativePostAdapter.ReadMoreOption.AddReadMoreTo(holder.AboutDescription, new String(holder.AboutDescription.Text));
                    }
                    catch (Exception e)
                    {
                    ...
                    holder.TxtUsername.Text = "@" + item.InfoUserModel.UserData.Username /*+ " /n" + Methods.Time.TimeAgo(Convert.ToInt32(item.InfoUserModel.UserData.LastseenUnixTime), false)*/;
        ...
        public void StoryBind(AdapterHolders.StoryViewHolder holder, AdapterModelsClass item)
        {
            try
            {
                ...
                holder.StoryAdapter2.StoryList = holder.StoryAdapter.StoryList;
                holder.StoryAdapter2.NotifyDataSetChanged();
