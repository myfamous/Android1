                    ...
                    case null:
                        StoryList.Add(new StoryDataObject
                        {
                            ...
                            Stories = new List<StoryDataObject.Story>
                            {
                                ...
                                {
                                    Thumbnail = ListUtils.MyProfileList?.FirstOrDefault().AvatarFull,
                                }
                            }
                        });
                        break;
                                ...
                                switch (item.Type)
                                {
                                    ...
                                    case "Live":
                                        { 
                                            ...
                                            GlideImageLoader.LoadImage(ActivityContext, item.AvatarFull , holder.RoundImage, ImageStyle.RoundedCrop, ImagePlaceholders.Drawable);
                                            GlideImageLoader.LoadImage(ActivityContext, item.AvatarFull, holder.Image, ImageStyle.CircleCrop, ImagePlaceholders.Drawable);
