...
{
    public class StoryFamousAdapter : RecyclerView.Adapter, ListPreloader.IPreloadModelProvider
    {
        ...
        public StoryFamousAdapter(Activity context)
        {
            try
            {
                HasStableIds = true;
        ...
        public override RecyclerView.ViewHolder OnCreateViewHolder(ViewGroup parent, int viewType)
        {
            try
            {
                ...
                var itemView = LayoutInflater.From(parent.Context)?.Inflate(Resource.Layout.Style_HStoryView2, parent, false);
                var vh = new StoryFamousAdapterViewHolder(itemView, Click, LongClick);
                return vh;
            }
        ...
        public override void OnBindViewHolder(RecyclerView.ViewHolder viewHolder, int position)
        {
            try
            {
                switch (viewHolder)
                {
                    case StoryFamousAdapterViewHolder holder:
                        {
    ...
    public class StoryFamousAdapterViewHolder : RecyclerView.ViewHolder
    {
        public StoryFamousAdapterViewHolder(View itemView, Action<StoryAdapterClickEventArgs> clickListener, Action<StoryAdapterClickEventArgs> longClickListener) : base(itemView)
        {
            try
            {
                MainView = itemView;

                RoundImage = MainView.FindViewById<CircleImageView>(Resource.Id.iv_round_story);
        ...
        public CircleImageView RoundImage { get; set; }
