    ...
    public class StoryReplyActivity : AppCompatActivity, DragToClose.IDragListener, MaterialDialog.IListCallback, IOnRecordClickListener, IOnRecordListener
    {
        ...
        private void InitComponent()
        {
            try
            {
                ...
                ChatStickersTabBoxFragment = new ChatStickersTabFragment("StoryReplyActivity");
                ...
                AXEmojiPager emojiPager = EmojisViewTools.LoadView(this, EmojIconEditTextView, "StoryReplyActivity");
                AXEmojiPopup popup = new AXEmojiPopup(emojiPager);
                var EmojisViewActions = new EmojisViewActions(this, "StoryReplyActivity", popup, EmojIconEditTextView, ChatEmojImage);
