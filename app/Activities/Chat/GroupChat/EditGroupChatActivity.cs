                ...
                else
                {
                    ...
                    else
                    {
                        try
                        {
                            ...
                            var (apiStatus1, respond1) = await RequestsAsync.GroupChat.AddOrRemoveUserToGroupAsync(GroupData.GroupId, UsersIds, "add_user").ConfigureAwait(false);
                            if (apiStatus1 == 200)
                            {

                            }
                            else Methods.DisplayReportResult(this, respond1);
                        }
                        catch (Exception exception)
                        {
