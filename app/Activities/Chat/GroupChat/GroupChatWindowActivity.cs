    ...
    public class GroupChatWindowActivity : AppCompatActivity, MaterialDialog.IListCallback, View.IOnLayoutChangeListener, IOnRecordClickListener, IOnRecordListener, SwipeReply.ISwipeControllerActions
    {
        ...
        private void InitComponent()
        {
            try
            {
                ...
                AXEmojiPager emojiPager = EmojisViewTools.LoadView(this, EmojIconEditTextView, "GroupChatWindowActivity");
                AXEmojiPopup popup = new AXEmojiPopup(emojiPager);
                var emojisViewActions = new EmojisViewActions(this, "GroupChatWindowActivity", popup, EmojIconEditTextView, ChatEmojImage);
                        ...
                        case Holders.TypeClick.Image:
                            {
                                ...
                                {
                                    var fileName = item.MesData.Media.Split('/').Last();
                                    var mediaFile = WoWonderTools.GetFile(GroupId, Methods.Path.FolderDcimImage, fileName, item.MesData.Media);
                ...
                else if (requestCode == 501 && resultCode == Result.Ok) // right_video 
                {
                    ...
                    if (filepath != null)
                    {
                        ...
                        if (type == "Video")
                        {
                            ...
                            var pathWithoutFilename = Methods.Path.FolderDcimVideo + GroupId;
                            var fullPathFile = new File(Methods.Path.FolderDcimVideo + GroupId, fileNameWithoutExtension + ".png");
                            ...
                            case MessageModelType.RightVideo:
                                {
                                    ...
                                    {
                                        var mediaFile = WoWonderTools.GetFile(GroupId, Methods.Path.FolderDcimVideo, fileName, SelectedItemPositions.MesData.Media);
                                        File file2 = new File(mediaFile);
                                        try
                                        {
                            ...
                            case MessageModelType.RightGif:
                                {
                                    ...
                                    SelectedItemPositions.MesData.Media = WoWonderTools.GetFile(GroupId, Methods.Path.FolderDiskGif, fileName, SelectedItemPositions.MesData.Media);
                            ...
                            case MessageModelType.RightSticker:
                                {
                                    ...
                                    SelectedItemPositions.MesData.Media = WoWonderTools.GetFile(GroupId, Methods.Path.FolderDiskSticker, fileName, SelectedItemPositions.MesData.Media);
                            ...
                            case MessageModelType.RightImage:
                                {
                                    ...
                                    SelectedItemPositions.MesData.Media = WoWonderTools.GetFile(GroupId, Methods.Path.FolderDcimImage, fileName, SelectedItemPositions.MesData.Media);
